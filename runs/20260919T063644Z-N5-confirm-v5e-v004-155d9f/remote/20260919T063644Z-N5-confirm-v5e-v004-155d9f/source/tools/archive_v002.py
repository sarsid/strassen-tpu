"""Version 002: immutable execution directories with source/result commits.
...
def main():
    ...
    env = dict(os.environ, PYTHONPATH=str(run / "source/src"), PYTHONUNBUFFERED="1", PYTHONDONTWRITEBYTECODE="1")
    code = -1
    error = None
    try:
