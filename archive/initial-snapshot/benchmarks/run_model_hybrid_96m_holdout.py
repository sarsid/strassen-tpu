"""Frozen-permutation holdout run of the hybrid full-checkpoint gate.

Loads the per-layer permutations saved by the calibration run, patches in the
disjoint holdout corpus, and evaluates with no retuning.
"""
...
gate.OUTPUT = Path(
    "/content/results/strassen_checkpoint_model_hybrid_holdout.jsonl"
)
layer_bench.TEXTS = (
