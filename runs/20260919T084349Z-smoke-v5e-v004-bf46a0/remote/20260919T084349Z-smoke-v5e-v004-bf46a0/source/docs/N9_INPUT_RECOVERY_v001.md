...
Mistral's official reference completed in `20260919T080927Z-N9-reference-mistral-v003-v5e-v004-00f4b2` (commit `aecc23b7`). Local finalization then exposed and repaired a validator-only archive-layout assumption, documented in [local validation incidents](LOCAL_VALIDATION_INCIDENTS_v001.md). The successful sealed input bundle is `plans/n9_inputs_final_20260919_v004/input_bundle.json`, created by `20260919T081552Z-N9-input-finalization-v004-a8f5bc` (commit `30bd41ce`). The N9 configuration was generated from that bundle and the exact N8 selections before any model-quality result was observed.
