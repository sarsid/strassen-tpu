"""Assemble vector figures, a completed-study flowchart and per-figure prose."""
...
def guide(c,charts):
    ...
    c.setFillColor(HexColor('white'));c.saveState();c.translate(877,base+58);c.rotate(45);c.rect(-3,-3,6,6,fill=1,stroke=1);c.restoreState()
