...
Version 003 preserves timed-out controller calls, conservatively records launch
...
def main():
    ...
    parser.add_argument('--benchmark-module', choices=['strassen_mm.benchmark_v001', 'strassen_mm.n4_real_weights_v001'], default='strassen_mm.benchmark_v001')
    ...
    label = args.phase + ('-real-weights' if args.benchmark_module.endswith('n4_real_weights_v001') else '') + '-v5e-v003'
    ...
    try:
        ...
        response = exec_remote('launch_phase_v003.py', [
