...
The [interactive gallery](../runs/20260919T143842Z-N1-N9-chartbook-v002-471048/artifacts/index.html)
contains 144 comparisons, including all measured matrix shapes. Its
[47-page PDF](../runs/20260919T143842Z-N1-N9-chartbook-v002-471048/artifacts/N1_N9_key_comparisons.pdf)
...
The delivered v002 rendering groups the PDF in experiment order and gives
near-equal ratios an extra significant digit. All benchmark evidence is unchanged.

To serve the delivered gallery locally:

```sh
python3 -m http.server 8766 --bind 127.0.0.1 --directory runs/20260919T143842Z-N1-N9-chartbook-v002-471048/artifacts
```
