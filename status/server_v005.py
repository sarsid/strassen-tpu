...
Version 005 preserves the earlier agent/run/commit views. Final result files
...
class Handler(BaseHTTPRequestHandler):
    def do_GET(self):
        ...
        if url.path == "/api/status":
            ...
            data = (ROOT / "status/index_v005.html").read_bytes()
...
if __name__ == "__main__":
    print("Status v005: http://127.0.0.1:8765", flush=True)
